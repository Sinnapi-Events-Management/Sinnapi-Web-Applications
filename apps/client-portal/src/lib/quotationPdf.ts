 ...
 *
 * Deliberately the same layout as the admin console's renderer: a client
 * forwarding this to their own accountant and an operator attaching it to a
 * dispute must be looking at the same document.
 */

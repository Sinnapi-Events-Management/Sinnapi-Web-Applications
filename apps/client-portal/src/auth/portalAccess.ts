 ...
 * wrong portal, locked out — all of it reads the same. Someone probing this
 * form with a stolen credential must not be able to tell a real address from a
 * fake one, or learn that the credential they hold is privileged.
 */

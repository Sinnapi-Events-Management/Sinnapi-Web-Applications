 ...
 * point of it. Accepting or declining is the reason a client opens a quote at
 * all; a decision one tab deep is a decision they have to go looking for.
 * Everything below the tabs is a record and can wait behind a tab — this
 * cannot.
 *
 * Deliberately separate from "Next steps", which is a set of links and lives in
 * the Overview section. This bar holds the controls that change the quotation
 * itself, and mixing a status write in among navigation is how someone taps one
 * without meaning to.
 *
 * The bar disappears entirely once the quote is settled rather than showing a
 ...
 */
export default function QuotationActionBar({ quotation }: Props) {

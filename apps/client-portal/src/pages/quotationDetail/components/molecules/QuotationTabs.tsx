...
type Props = {
  ...
  /** Unread messages in this vendor's thread, badged onto the Messages tab. */
  unreadCount?: number;
};
 ...
 *
 * The labels match the vendor's page one for one. A client and a vendor
 * comparing notes over one quote — which is what the message tab beside them is
 * for — should be able to say "the Payment tab" and mean the same screen.
 */

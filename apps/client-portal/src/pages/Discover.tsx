...
export default function Discover() {
  ...
  return (
    <>
      <PageTitle title="Discover vendors" subtitle="Search verified providers, then request a quote or book." />
      <Paper variant="outlined" component="form" onSubmit={search} sx={{ p: 2, mb: 3, display: "flex", gap: 2 }}>
        <TextField value={q} onChange={(e) => setQ(e.target.value)} label="Search vendors" />
        <Box><Button type="submit" variant="contained" sx={{ height: 40 }}>Search</Button></Box>
      </Paper>

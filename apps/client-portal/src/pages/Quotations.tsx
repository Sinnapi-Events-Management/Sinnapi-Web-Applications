...
import { Card, Table, TableHead, TableRow, TableCell, TableBody, Typography, Button } from "@mui/material";
  ...
  return (
    <>
      <PageTitle
        ...
        action={<Button component={RouterLink} to="/quotations/compare" variant="outlined" startIcon={<CompareArrowsIcon />}>Compare</Button>}
      />
      <QueryState isLoading={isLoading} error={error}>
        {rows.length === 0 ? (
          <EmptyState title="No quotations yet" description="Request a quote from a vendor to get started." ctaLabel="Discover vendors" ctaHref="/discover" />
        ) : (
          <Card variant="outlined">
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell>Reference</TableCell><TableCell>Vendor</TableCell><TableCell align="right">Total</TableCell>

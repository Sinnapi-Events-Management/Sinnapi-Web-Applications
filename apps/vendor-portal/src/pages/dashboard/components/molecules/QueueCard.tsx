 ...
 *
 * Deliberately four elements (badge, label, count, one status line). The trend
 * behind each of these still exists in the payload and is read on the analytics
 * tabs, where a chart is the point; here it would put forty competing marks in
 * the band a vendor is meant to *scan*.
 */
    ...
    <Card variant="outlined" sx={{ height: '100%', borderRadius: 3 }}>
      ...
      >
        ...
        <Box sx={{ mt: 1, minHeight: 24 }}>
          {/* One status line only. An empty queue is worth saying out loud —
              it is the difference between "nothing waiting" and "not loaded". */}
          {clear ? (
            <Chip
              size="small"
              color="success"

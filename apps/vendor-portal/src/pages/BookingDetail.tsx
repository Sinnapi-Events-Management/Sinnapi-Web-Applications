...
import { Grid, Card, CardContent, Typography, Stack, Divider, Box } from "@mui/material";
  ...
  return (
    <QueryState isLoading={isLoading} error={error}>
      {!b ? (
        ...
        <>
          <PageTitle title={`Booking ${b.reference_no}`} subtitle={one<any>(b.profiles)?.full_name} action={<StatusChip status={b.status} size="medium" />} />

...
import { Stack, TextField, Button, Alert, Typography, MenuItem } from "@mui/material";
...
export default function SignUpForm() {
  ...
  if (done) return <Alert severity="success">Check your email to confirm your account, then sign in.</Alert>;
  ...
  return (
    <Stack component="form" spacing={2.5} onSubmit={onSubmit} noValidate>
      ...
      <TextField name="password" type="password" label="Password" autoComplete="new-password" required helperText="At least 8 characters" />
      ...
      <Typography variant="body2" color="text.secondary">Already have an account? <RouterLink to="/sign-in">Sign in</RouterLink></Typography>
    </Stack>
  );
}

 ...
 *
 * Deliberately the same layout as the client portal's and the admin console's
 * renderers: a vendor filing this with their own books, a client forwarding it
 * to their accountant and an operator attaching it to a dispute must all be

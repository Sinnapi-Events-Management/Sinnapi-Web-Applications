import { Paper, Rating, Stack, Typography } from '@sinnapi/ui/atoms';
 ...
 */
export default function RatingSummary({ vendor }: { vendor: VendorDetailModel }) {
      ...
      >
        <Stack direction="row" spacing={1} alignItems="baseline">
          <Typography variant="h3" sx={{ lineHeight: 1 }}>
            {count > 0 ? vendor.avg_rating.toFixed(1) : '—'}
          </Typography>

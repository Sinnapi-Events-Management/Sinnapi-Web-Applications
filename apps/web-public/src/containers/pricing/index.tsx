...
// Pricing page: shows vendor subscription plans and their feature matrix.
export default function PricingContainer() {
  return (
    <>
      <PageHeader
        title="Vendor pricing"
        subtitle="Start with a 30-day free trial after approval. Choose the plan that fits your business."
      />
      <Container sx={{ py: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 3, textAlign: 'center' }}>
          Prices are shown during onboarding and may vary by billing cycle. Inactive subscriptions
          hide your public listing until renewed.
        </Typography>
      </Container>
    </>
  );

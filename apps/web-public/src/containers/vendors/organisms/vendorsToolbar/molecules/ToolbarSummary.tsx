 ...
 * compare against, so it states the size of the marketplace. Filtered, it
 * reports how much of the matching set is on screen — which is the honest
 * reading for an infinitely-scrolling grid, where "24 of 112" tells you both
 * that your filter matched a lot and that you haven't seen it all yet.
 *
 * Renders a skeleton rather than "0 vendors" on first load: a real zero is

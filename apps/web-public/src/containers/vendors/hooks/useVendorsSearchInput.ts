...
export const RESULTS_ANCHOR_ID = 'vendor-results';

/**
 * Search-as-you-type for the vendors hero.
 *
 * The input is uncontrolled by the URL while the visitor is typing — local
 * state keeps every keystroke instant — and commits to the URL once they pause,
 * which is what actually triggers the refetch. Committing per keystroke would
 * fire a query for "p", "ph", "pho"… and make the grid strobe.
 *

...
import { Box, Container, Grid, Typography, Link, Stack } from '@sinnapi/ui';
      ...
      <Container>
        <Grid container spacing={4}>
          <Grid item xs={12} md={4}>
            <Typography
              variant="h5"
              sx={{ fontFamily: 'var(--font-fraunces)', fontWeight: 600, color: 'common.white' }}
            >
              {SITE.name}
            </Typography>
        ...
        <Typography variant="caption" sx={{ display: 'block', mt: 5, color: 'grey.500' }}>
          © {new Date().getFullYear()} {SITE.name}. Empowering everyone to plan their events

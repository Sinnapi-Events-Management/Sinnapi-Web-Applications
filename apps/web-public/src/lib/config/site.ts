...
export const VENDOR_CATEGORIES = [
  "photographer", "videographer", "decorator", "caterer", "makeup_artist",
  "mc", "dj", "venue", "florist", "security", "entertainment", "equipment",
];

export const SERVICE_REGIONS = [
  "kampala", "central", "eastern", "western", "northern", "nationwide", "east_africa", "international",
];
...
export function formatMoney(amount: number | null, currency: string | null): string | null {
  ...
  try {
    return new Intl.NumberFormat("en-UG", {
      style: "currency", currency: cur, maximumFractionDigits: cur === "UGX" ? 0 : 2,
    }).format(amount);
  } catch {

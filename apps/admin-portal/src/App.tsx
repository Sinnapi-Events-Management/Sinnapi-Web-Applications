...
const g = (perm: string | undefined, el: React.ReactNode) => <RequirePerm perm={perm}>{el}</RequirePerm>;
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/notification-templates" element={g("settings.manage", <NotificationTemplates />)} />

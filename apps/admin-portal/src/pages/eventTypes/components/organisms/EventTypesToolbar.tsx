...
import type { EventTypeFiltersState } from '../../hooks/useEventTypes';

type Props = {
  filters: EventTypeFiltersState;
};
...
/**
 * Vocabulary filters. Presentational: it renders the controls and delegates
 * every change to the `filters` state the page hook owns. The create entry
 * point lives in the page header (see EventTypes).
 */
export default function EventTypesToolbar({ filters }: Props) {
  return (
    <Stack

...
import { SCOPE_OPTIONS } from '../../schema';
import type { RegionFiltersState } from '../../hooks/useServiceRegions';

type Props = {
  filters: RegionFiltersState;
};
 ...
 * point lives in the page header (see ServiceRegions).
 */
export default function RegionsToolbar({ filters }: Props) {
  return (
    <Stack
